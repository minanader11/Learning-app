...
import 'package:mario_app/core/imageHelper.dart';
    ...
    return BlocListener<LoginViewModel, LoginStates>(
      ...
      listener: (context, state) {
        if (state is LoginLoadingState) {
          ...
          //       Navigator.of(context).pushReplacementNamed(MainScreen.routeName);
          //     });
        } else if (state is LoginGmailSuccessState){
        //  DialogUtils.hideLoading(context);
          var ftoast = FToast();
          ftoast.init(context);
          ftoast.showToast(
          ...
          Navigator.of(context).pushReplacementNamed(MainScreen.routeName);
        } else if (state is LoginGmailErrorState) {
          DialogUtils.hideLoading(context);
          //  DialogUtils.hideLoading(context);
          DialogUtils.showMessage(
              context: context,
                      ...
                      child: RichText(
                        text: TextSpan(
                          ...
                          children: <TextSpan>[
                            ...
                            TextSpan(
                                text: MyTexts.registerHere,
                                style: Styles.textStyle14.copyWith(
                                    color: MyColors.buttonsPurpleColor)),
                          ],
                        ),
                      ),
                    ),
                    ...
                    InkWell(
                      ...
                      child: Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              color:
                                  MyColors.buttonsPurpleColor.withOpacity(0.2)),
                          child: ImageHelper(
                              image: ImagePaths.googleICon,
