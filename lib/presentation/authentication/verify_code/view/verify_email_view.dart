...
class _VerifyEmailScreenState extends State<VerifyEmailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return  BlocProvider<VerifyScreenViewModel>(create: (context) => verifyScreenViewModel,
        child: BlocListener<VerifyScreenViewModel,VerifyScreenStates>(listener:(context, state) {
